  ...
  <section id="testimonials" class="hoc container clear">
	...
	if (isset($_POST['submit'])) {
		...
		$newpass = md5($myPassword); //This will make your password encrypted into md5, a high security hash
      	...
      	$sql = mysqli_query( $con,"INSERT INTO tbAdministrators(first_name, last_name, email, password) VALUES ('$myFirstName','$myLastName', '$myEmail', '$myPassword')" ) or die( mysqli_error() );
...
/*					$sql = mysql_query( "UPDATE tbAdministrators SET first_name='$myFirstName', last_name='$myLastName', email='$myEmail', password='$newpass' WHERE admin_id = '$myId'" )
      	...
      	$sql = mysqli_query( $con,"UPDATE tbAdministrators SET first_name='$myFirstName', last_name='$myLastName', email='$myEmail', password='$myPassword' WHERE admin_id = '$myId'" ) or die( mysql_error() );
